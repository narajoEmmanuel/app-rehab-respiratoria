...
/** Perfil RESPIRA+ 3000 mL: referencia para constantes globales de volumen. */
const DEFAULT_3000_PROFILE = getSpirometerProfileById(SPIROMETER_PROFILE_3000ML_ID)!;

export const MIN_OPERATIVE_VOLUME_ML = DEFAULT_3000_PROFILE.operativeMinVolumeMl;

export const RECOMMENDED_RANGE_ML = {
  min: DEFAULT_3000_PROFILE.recommendedMinVolumeMl,
  max: DEFAULT_3000_PROFILE.recommendedMaxVolumeMl,
} as const;

export const EXTENDED_RANGE_ML = {
  min: DEFAULT_3000_PROFILE.recommendedMaxVolumeMl + DEFAULT_3000_PROFILE.calibrationStepMl,
  max: DEFAULT_3000_PROFILE.extendedMaxVolumeMl,
} as const;

export const EXPECTED_MIN_VOLUME_ML = DEFAULT_3000_PROFILE.operativeMinVolumeMl;
export const EXPECTED_RECOMMENDED_MAX_VOLUME_ML = DEFAULT_3000_PROFILE.recommendedMaxVolumeMl;
export const EXPECTED_MAX_VOLUME_ML = DEFAULT_3000_PROFILE.maxVolumeMl;

export const OPERATIVE_VOLUME_CHIPS_ML = DEFAULT_3000_PROFILE.volumeChipsMl;

export const REQUIRED_RECOMMENDED_VOLUMES_ML = DEFAULT_3000_PROFILE.requiredVolumesMl;
...
export const EXTENDED_VOLUME_CHIPS_ML = OPERATIVE_VOLUME_CHIPS_ML.filter(
  (v) => v > DEFAULT_3000_PROFILE.recommendedMaxVolumeMl,
);
...
export const CURRENT_SPIROMETER_PROFILE = {
  maxVolumeMl: DEFAULT_3000_PROFILE.maxVolumeMl,
  operativeMinVolumeMl: DEFAULT_3000_PROFILE.operativeMinVolumeMl,
  recommendedMaxVolumeMl: DEFAULT_3000_PROFILE.recommendedMaxVolumeMl,
  calibrationStepMl: DEFAULT_3000_PROFILE.calibrationStepMl,
  expectedDistanceStepMm: DEFAULT_3000_PROFILE.expectedDistanceStepMm,
  geometricValidationEnabled: DEFAULT_3000_PROFILE.geometricValidationEnabled,
  geometrySource: DEFAULT_3000_PROFILE.geometrySource,
} as const;

export const EXPECTED_VOLUME_STEP_ML = DEFAULT_3000_PROFILE.calibrationStepMl;

export const EXPECTED_DISTANCE_STEP_PER_500ML_MM = 10;

export const GEOMETRIC_VALIDATION_SOURCE = DEFAULT_3000_PROFILE.geometrySource;
...
export const REQUIRED_GEOMETRIC_SEGMENTS_ML = DEFAULT_3000_PROFILE.requiredVolumesMl
  .slice(1)
  .map((to, i) => [DEFAULT_3000_PROFILE.requiredVolumesMl[i], to] as [number, number]);
