...
| Modelo | Lineal predeterminado validado por el equipo |
| Ecuación | `Volumen = 32.566738232013954 × distanceMm − 1270.5786467848384` |
| Clamp | 0–3000 mL |
| Origen del volumen | **App** (a partir de `distanceMm` del ESP32) |
